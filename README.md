...
2. `cd my-project`
3. Open your AI agent (Claude Code, Codex, Cursor, or Gemini) in the project folder
4. Say: *"What project are we building today?"*
5. The agent asks 5 questions, picks a stack, generates backlog, and starts working
...
TFW updates touch only workflow files (`.claude/`, `AGENTS.md`, `docs/workflow/`, `docs/guides/`). Your project files (`SESSION_MEMORY.md`, `CHANGELOG.md`, `ROADMAP.md`, backlogs) won't conflict because they start as empty templates on `master`.
